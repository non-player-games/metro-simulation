...
var BLUEBERRY_LINE = Line{[]Station{MAPLE_STATION, REDWOOD_STATION, OAK_STATION, ASH_STATION, PINE_STATION}, "Blueberry"}
var ORANGE_LINE = Line{[]Station{ASH_STATION, ELM_STATION, MAHOGANY_STATION}, "Orange"}
var BANANA_LINE = Line{[]Station{ELM_STATION, HOLLY_STATION, CEDAR_STATION}, "Banana"}
